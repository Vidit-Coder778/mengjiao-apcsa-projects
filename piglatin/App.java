...
public class App {
    public static void main(String[] args)
    {
        ...
        if (score > 4)
        {
            ...
            // tried to do other book: input.readFromUrl("Ten years experience in raising carrots and cabbage ", "https://www.gutenberg.org/cache/epub/77128/pg77128-images.html.txt");
